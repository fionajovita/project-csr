...
function showScore(score){
    ...
    if(score ==6){
        ...
        var name1 = document.cookie.match('(^|;) ?' + "short" + '=([^;]*)(;|$)');
        var name2 = document.cookie.match('(^|;) ?' + "long" + '=([^;]*)(;|$)');
        var name3 = document.cookie.match('(^|;) ?' + "intermittent" + '=([^;]*)(;|$)');
        if (name1 && name2 && name3) {
            
            btn1.style.display = "block";
            btn1.innerHTML = '<img src="../../../images/nextLevel.png" />';
            btn1.onclick = function(){
            location.href = '/pages/quiz/quiz3.html';
            }
        }
        else {
            
            btn1.style.display = "block";           
            btn1.innerHTML = '<img src="../../../images/nextModule.png" />';
            btn1.onclick = function(){
            location.href = '/pages/learning/level2.html';
            }
        }
        ...
        btn1.innerHTML = '<img src="../../../images/retakeModule.png" />';
        btn1.onclick = function(){
            location.href = '/pages/learning/link-sounds.html';
        }
        btn2.innerHTML = '<img src="../../../images/retakeQuiz.png" />';        
        btn2.onclick = function(){
            location.href = '/pages/quiz/link-sounds.html';
        }
    }
}
