...
function showScore(score){
    ...
    if(score ==6){
        ...
        var name1 = document.cookie.match('(^|;) ?' + "fruits" + '=([^;]*)(;|$)');
        var name2 = document.cookie.match('(^|;) ?' + "vehicles" + '=([^;]*)(;|$)');
        var name3 = document.cookie.match('(^|;) ?' + "animals" + '=([^;]*)(;|$)');
        if (name1 && name2 && name3) {
            
            btn1.style.display = "block";
            btn1.innerHTML = '<img src="../../../images/nextLevel.png" />';
            btn1.onclick = function(){
            location.href = '/pages/quiz/advanced.html';
            }
        }
        else {
            ...
            btn1.onclick = function(){
            location.href = '/pages/learning/level3.html';
            }
        }
